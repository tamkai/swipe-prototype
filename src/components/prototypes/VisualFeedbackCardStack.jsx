...
import VisualFeedbackSwipeCard from './VisualFeedbackSwipeCard';

const VisualFeedbackCardStack = ({ questions, onComplete }) => {
  ...
  const handleSwipe = (direction, question) => {
    ...
    // 次のカードへ
    const delay = direction === 'skip' ? 300 : 250;
    setTimeout(() => {
...
export default VisualFeedbackCardStack;
